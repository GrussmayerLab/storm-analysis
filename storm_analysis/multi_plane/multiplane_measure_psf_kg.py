...
mappings = {"0_0_x" : numpy.array([0.0, 1.0, 0.0]),
            ...
            "0_2_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_2_y" : numpy.array([5.0, 0.0, 1.0]),
            "0_3_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_3_y" : numpy.array([5.0, 0.0, 1.0]),
            "0_4_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_4_y" : numpy.array([5.0, 0.0, 1.0]),
            "0_5_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_5_y" : numpy.array([5.0, 0.0, 1.0]),
            "0_6_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_6_y" : numpy.array([5.0, 0.0, 1.0]),
            "0_7_x" : numpy.array([2.0, 1.0, 0.0]),
            "0_7_y" : numpy.array([5.0, 0.0, 1.0]),
...
def sCMOSSingleFrameXML():
    ...
    params.setAttr("threshold", "float", 15.0) #20
